...
def R21001(DATA, FIELDS_LEN, FIELDS_NAME, field_data):
    filename = "E:\\LETI\\3_kurs\\5sem\\IT-Projects\\startbusiness\\src\\main\\resources\\documents\\samples\\R21001.pdf"
    ...
    for field, value in field_data.items():
        for page in pdf_writer.pages:
            try:
                ...
                pass
    new_file_name = "E:\\LETI\\3_kurs\\5sem\\IT-Projects\\startbusiness\\src\\main\\resources\\documents\\R21001_" + DATA[6] + ".pdf"
...
def start_R21001():
    ...
    file_path = "E:\\LETI\\3_kurs\\5sem\\IT-Projects\\startbusiness\\src\\main\\resources\\documents\\R21001_" + str(empl_infs[6]) + ".pdf"
